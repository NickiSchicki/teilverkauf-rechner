  ...
  var GES_GROUPS = [
    { title: "Gesellschaft", dot: "s3", zuImDetail: true, hinweis: "gilt für alle Objekte", items: [
      ...
      { id: "anlage", label: "Anlagezins", min: 0, max: 6, step: 0.1, fmt: function (v) { return fPct(v, 2) + " p.a."; }, note: "verzinst jedes Guthaben der Gesellschaft, nicht nur geparkte Verkaufserlöse" },
      ...
      { id: "mindestRendite", label: "Renditeanspruch", min: 0, max: 12, step: 0.25, fmt: function (v) { return fPct(v, 2) + " p.a."; }, note: "eigene Vorgabe an die Eigenkapitalrendite nach Steuern der GmbH, vor Ausschüttung — Maßstab für Break-even und Ankaufsfilter" }
    ], tax: true }
  ];
  ...
  var OBJ_GROUPS = [
    { title: "Immobilie & Haushalt", items: [
      ...
      { id: "alter", label: "Alter im Haushalt", min: 55, max: 95, step: 1, fmt: fJahre, note: "bei Paaren für beide Personen unterstellt" },
    ...
    { title: "Vertrag", dot: "s1", items: [
      { id: "ne", label: "Nutzungsentgelt", min: 1, max: 9, step: 0.05, fmt: function (v) { return fPct(v, 2) + " p.a."; }, note: "in Prozent des Auszahlungsbetrags, nicht des Immobilienwerts" },
      ...
      { id: "holdAuto", label: "Haltedauer aus Sterbetafel", bool: true, note: "Bilanz, Liquidität und Steuern rechnen dann mit der Median-Haltedauer; Kapitalwert und erwartete Rendite über die gesamte Verteilung" },
    ...
    { title: "Ankauf & Finanzierung", dot: "s2", zu: true, hinweis: "Nebenkosten, Darlehen", items: [
      ...
      { id: "ltv", label: "Beleihung", min: 0, max: 95, step: 5, fmt: function (v) { return fPct(v, 0); }, note: "Darlehen in % der Auszahlung nach Ankaufsabschlag — Nebenkosten werden nicht mitfinanziert" },
      ...
      { id: "zinsbindung", label: "Zinsbindung", min: 5, max: 30, step: 1, fmt: fJahre, note: "Bindung des Darlehens — vorher keine Ablösung ohne Entschädigung" },
      { id: "weiterfuehren", label: "Bei Verkauf weiterführen", bool: true, note: "Darlehen läuft bis zum Ende der Zinsbindung weiter, der Erlös wird bis dahin angelegt" }
    ] },
