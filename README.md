...
- **Akquisitionskosten** je Vertragsabschluss als sofort abzugsfähiger Vertriebsaufwand — anders als die Maklercourtage werden sie nicht aktiviert, erhöhen aber den Eigenkapitalbedarf.
- **Hebelwirkung der Finanzierung** als Vergleich desselben Objekts mit und ohne Darlehen. Liegt die unverschuldete Rendite unter den Fremdkapitalkosten nach Steuern, senkt jeder Euro Darlehen die Eigenkapitalrendite.
- **Nötiger Immobilienwert** als Umkehrung der Renditerechnung in eine Marktaussage: Auf welchen Anteil des heutigen Werts muss der Verkaufspreis kommen, damit der Renditeanspruch aufgeht? Die Größe hängt am verkauften Anteil, am Entgelt und an allen Kosten — sie lässt sich aber unmittelbar mit einer eigenen Markteinschätzung vergleichen.
...
- **Break-even** über den Kapitalwert gegen einen frei einstellbaren Renditeanspruch, nicht über den internen Zinsfuß, der bei kurzen Haltedauern nicht eindeutig ist.
- **Ankaufsfilter** als Umkehrrechnung: Zu jeder Stellschraube — Nutzungsentgelt, Mindesterlös, Ankaufsabschlag, Wertentwicklung, Sollzins, Erwerbsnebenkosten — wird der Wert bestimmt, bei dem der Renditeanspruch ceteris paribus gerade erreicht wird. Der Renditeanspruch selbst steht als erste Zeile in derselben Tabelle; sein kritischer Wert ist die Rendite, die der Vertrag tatsächlich abwirft. Er lässt sich nicht per Knopfdruck absenken — er ist die Vorgabe, an der gemessen wird.
